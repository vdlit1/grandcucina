...
class Fontis_EwayAu_Model_Direct extends Mage_Payment_Model_Method_Cc
{
    ...
    public function getRefundGatewayUrl() {
    	if(Mage::getStoreConfig('payment/ewayau_direct/test_gateway')) {
    ...
    public function callDoDirectPayment()
    {
        ...
        // INCHOO CHANGES
       	$invoiceDesc = Mage::helper('core/string')->substr($invoiceDesc, 0, 250) . "...";
       	// INCHOO CHANGES
    ...
    public function callDoRefund()
    {
        ...
        $http->write(Zend_Http_Client::POST, $this->getRefundGatewayUrl(), '1.1', array(), $xml->asXML());
        $response = $http->read();
