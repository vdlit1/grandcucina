...
class Magazento_Megamenu_Block_Admin_Category_Edit_Tab_Other extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $fieldset->addField('content_top', 'editor', array(
            'name' => 'content_top',
            'label' => Mage::helper('megamenu')->__('3rd Column'),
            'title' => Mage::helper('megamenu')->__('3rd Column'),
            'style' => 'height:16em',
        ...
        $fieldset->addField('content_bottom', 'editor', array(
            'name' => 'content_bottom',
            'label' => Mage::helper('megamenu')->__('4th Column'),
            'title' => Mage::helper('megamenu')->__('4th Column'),
            'style' => 'height:16em',
            'config' => $wysiwygConfig,
            'required' => false,
        ));
