 ...
 */
class Atd_Tagimage_Block_Adminhtml_Tagimage_Edit_Tab_Categoryleft extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('imagestag/tab/categoryleft.phtml');
    }
