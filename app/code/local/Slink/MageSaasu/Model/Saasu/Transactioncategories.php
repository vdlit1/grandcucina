<?php
/**
 * Slink Saasu Transaction Category (Chart of Accounts)
 *
 * NOTICE OF LICENSE
 *
...
class Slink_MageSaasu_Model_Saasu_Transactioncategories extends Slink_MageSaasu_Model_Saasu_Abstract{
 
    /* Saasu Transaction Category Fields */
    protected $transactionCategoryUid="";
    ...
    public function get(){        
        ...
        $accounts = $doc->getElementsByTagName('transactionCategoryListItem');
    ...
    public function url(){
        if($this->getData('fileuid') && $this->getData('wsaccesskey')){
            ...
            return $this->endpoint.DS."TransactionCategoryList?wsaccesskey=".$this->getData('wsaccesskey')."&fileuid=".$this->getData('fileuid');
